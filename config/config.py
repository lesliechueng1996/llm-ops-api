...
class Config:
    def __init__(self):
        ...
        self.CELERY = {
            "broker_url": f"redis://{self.REDIS_HOST}:{self.REDIS_PORT}/{_get_env('CELERY_BROKER_DB')}",
            "result_backend": f"redis://{self.REDIS_HOST}:{self.REDIS_PORT}/{_get_env('CELERY_RESULT_BACKEND_DB')}",
